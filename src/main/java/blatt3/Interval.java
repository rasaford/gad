...
/**
 * Objekte der Klasse Interval stellen einen Bereich von Zahlen dar. Die Intervallgrenzen sind dabei
...
abstract class Interval {
  ...
  /**
   * Diese Methode gibt die Größe des Intervalls zurück. Zu beachten ist dabei, dass falls getFrom()
   * > getTo() gilt, das Intervall die Elemente in den Teilintervallen [usage.getFrom(); baseSize -
   * 1] und [0; usage.getTo()] abdeckt.
   *
   * @param baseSize die Basisgröße, anhand derer ein Umbruch innerhalb des Intervalls festgestellt
   * wird
