...
//  }
  ...
  /**
   * Diese Methode ist zum Debuggen gedacht und prüft, ob es sich um einen validen AVL-Baum handelt.
   * Dabei werden die folgenden Eigenschaften geprüft:
   *
   * - Die Höhe des linken Teilbaumes eines Knotens unterscheidet sich von der Höhe des rechten
   * Teilbaumes um höchstens eins. - Die Schlüssel im linken Teilbaum eines Knotens sind kleiner als
   * der oder gleich dem Schlüssel des Knotens. - Die Schlüssel im rechten Teilbaum eines Knotens
   * sind größer als der Schlüssel des Knotens. - Die Balancierung jedes Knoten entspricht der
